...
| `ENABLE_JELLYFIN_API`             | Enable Jellyfin API             | boolean    | `false`                                      | Expose /jellyfin as an in-process Jellyfin-compatible player API. It uses existing AIOStreams users, returns only direct provider streams, and never proxies media bytes.                                                                                                              |
